...
export class LoginComponent {
  ...
  onSubmit() {
    ...
    if (this.LoginForm.valid) {
      ...
      body.set('email', this.LoginForm.get('email')!.value!.trim());
      body.set('password', this.LoginForm.get('password')!.value!.trim());
      this.AuthService.signin(body).subscribe(
        (response) => {
          this.color='success';
          this.colorfill='green';
          this.status='Login_page_Toast_Status_Success';
          this. message='Login_page_Toast_Message_Success';
          this.toggleToast();
